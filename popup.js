const rules = [
    ...
    {pattern: /^https?:\/\/(?:[^.]+\.)?amazon\.com\/(?:.*?\/)?(?:dp|gp\/product|d)\/([0-9A-Z]+)/, sub: "https://amzn.com/dp/$1"},
    {pattern: /^https?:\/\/(?:[^.]+\.)?amazon\.com\/hz\/(?:.*?\/)?(?:gp\/registry\/wishlist|wishlist\/genericItemsPage|wishlist\/ls)\/([0-9A-Z]+)/, sub: "https://amzn.com/wishlist/$1"},
