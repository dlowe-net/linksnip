const rules = [
    ...
    {pattern: /^https?:\/\/(?:www\.|smile\.)?amazon\.com\/(?:.*?\/)?(?:dp|gp\/product|d)\/([0-9A-Z]+)/, sub: "https://amzn.com/dp/$1"},
    {pattern: /^https?:\/\/(?:www\.|smile\.)?amazon\.com\/hz\/(?:.*?\/)?(?:gp\/registry\/wishlist|wishlist\/genericItemsPage|wishlist\/ls)\/([0-9A-Z]+)/, sub: "https://amzn.com/wishlist/$1"},
    ...
    {pattern: /^https?:\/\/(?:www\.)?bugs.dolphin-emu.org\/issues\/([0-9]+)/, sub: "https://dolp.in/i$1"},
    // TODO: parse issuecomment out of anchor?
    {pattern: /^https?:\/\/(?:www\.)?github.com\/dolphin-emu\/dolphin\/pull\/([0-9]+)/, sub: "https://dolp.in/pr$1"},
    {pattern: /^https?:\/\/(?:www\.)?github.com\/golang\/go\/issues\/([0-9]+)/, sub: "https://go.dev/issues/$1"},
    {pattern: /^https?:\/\/(?:www\.)?go-review.googlesource.com\/c\/go\/\+\/([0-9]+)/, sub: "https://go.dev/cl/$1"},
    {pattern: /^https?:\/\/(?:www\.)?go-review.git.corp.google.com\/c\/go\/\+\/([0-9]+)/, sub: "https://go.dev/cl/$1"},
    {pattern: /^https?:\/\/(?:www\.)?github.com\/kubernetes\/enhancements\/issues\/([0-9]+)/, sub: "https://kep.k8s.io/$1"},
    {pattern: /^https?:\/\/(?:www\.)?github.com\/kubernetes\/features\/issues\/([0-9]+)/, sub: "https://feature.k8s.io/$1"},
    {pattern: /^https?:\/\/(?:www\.)?github.com\/kubernetes\/kubernetes\/issues\/([0-9]+)/, sub: "https://issues.k8s.io/$1"},
